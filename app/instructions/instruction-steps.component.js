...
var InstructionStepsComponent = (function () {
    ...
    InstructionStepsComponent.prototype.openFindAndReplaceView = function () {
        var link = ['/find-and-replace'];
        this.router.navigate(link);
    };
    InstructionStepsComponent.prototype.ngOnDestroy = function () {
        console.log("InstructionSteps being destroyed");
        //  console.log($("main"));
        //  $("#main").remove();
        //  console.log($("main"));
    };
    InstructionStepsComponent.prototype.ngAfterViewInit = function () {
